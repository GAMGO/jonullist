    ...
    const verifyPasswordAndProceed = async () => {
        ...
        try {
            ...
            if (modalAction === 'editAccount') {
                ...
                nav.navigate('RecoveryScreens', { screen: 'setQuestions' });
            }
        ...
        return (
            <View style={[styles.center, { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)' }]}>
                <View style={[styles.card, { width: '80%' }]}>
                    ...
                    <TextInput style={styles.input} placeholder="비밀번호를 입력하세요" secureTextEntry value={passwordForVerification} onChangeText={setPasswordForVerification} />
                    ...
                    <View style={styles.card}>
                        ...
                        {!editingAccount ? (
                            <>
                                ...
                                {/* ⭐️⭐️ 수정: 보안 질문 설정 여부에 따라 버튼 렌더링 ⭐️⭐️ */}
                                {hasSecurityQuestions ? (
                                    // 보안 질문이 설정된 경우 '계정 정보 수정' 버튼만 표시
                                    ...
                                    // 보안 질문이 설정되지 않은 경우 '보안 질문 설정' 버튼 표시
